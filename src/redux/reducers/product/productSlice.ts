...
export const addToWishlist = createAsyncThunk('productSlice/addToWishlist', async (prodId: string, thunkAPI) => {
    try {
        ...
        toast.success(`An item added to wishlist`, {
...
//remove wishlist
export const removeFromWishlist = createAsyncThunk('productSlice/removeFromWishlist', async (prodId: string, thunkAPI) => {
    try {
        const wishlist = await productService.removeWishlist(prodId)
...
const productSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(getAllProducts.pending, (state) => {
            ...
            // console.log("Hello here is stte.products ::: ", state.products);

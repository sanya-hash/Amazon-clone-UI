...
import { removeFromCart, increaseCart, descreaseCart, clearCart, cartTotal, CartItem } from '../../redux/reducers/cart/cartSlice';
                                ...
                                cartItems?.map((cartItem: CartItem, index: number) => (
                                    <section key={cartItem?.id}
                                        ...
                                        <div className='col-span-2 '>
                                            ...
                                            <p className='line-clamp-1 font-Rubik text-[.91rem]'>Price: $ {cartItem?.price} </p>

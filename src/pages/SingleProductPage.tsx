                            ...
                            <section className="block lg:flex gap-5 w-full mt-5">
                                ...
                                <div className="lg:w-1/2 text-skin-base mt-5 lg:mt-0">
                                    ...
                                    <div className="flex items-center h-fit w-fit">
                                        ...
                                        <span onClick={() => ToWishlist(singleProduct?.id as string)} className="cursor-pointer group h-fit transition-all delay-100 hover:bg-pink-600 p-4 bg-gray-300 rounded-md ml-5">
                                            {loading ?
                                                <MoonLoader
                                                    size={20}
                                                    color="#361AE3"
                                                    ...
                                                    data-testid="loader"
                                                />
                                                : wishlist?.find((id: any) => id?.id === singleProduct?.id)
